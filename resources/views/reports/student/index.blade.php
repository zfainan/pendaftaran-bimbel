...
@section('page-header')
    <div class="page-header">
        <h3 class="page-title"> Generate Laporan Data Siswa </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Laporan</li>
                <li class="breadcrumb-item active" aria-current="page">Generate Laporan Data Siswa</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="card">
        <div class="card-body">
            <form class="forms-sample" data-bitwarden-watching="1" method="POST"
                action="{{ route('reports.students.generate') }}">
                @csrf
