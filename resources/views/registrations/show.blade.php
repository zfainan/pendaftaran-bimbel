...
@section('page-header')
    <div class="page-header">
        <h3 class="page-title"> Detail Data Siswa {{ $student->nama }} </h3>
...
@section('content')
    ...
    <div class="card">
        <div class="d-flex p-4 pb-0">
            <a href="{{ route('students.edit', $student) }}" class="ms-auto btn btn-outline-info border"><i class="mdi mdi-pen me-2"></i> Edit Data</a>
        </div>
        <div class="card-body">
            <div class="forms-sample">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="tgl_lahir" value="{{ $student->tgl_lahir }}"
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input name="gender" type="radio" class="form-check-input" name="optionsRadios"
                                        id="optionsRadios1" value="L" @checked($student->gender == 'L') disabled> Laki-laki
                                    <i class="input-helper"></i></label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input name="gender" type="radio" class="form-check-input" name="optionsRadios"
                                        id="optionsRadios2" value="P" @checked($student->gender == 'P') disabled> Perempuan
                                    <i class="input-helper"></i></label>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="kelas" value="{{ $student->kelas }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="asal_sekolah" value="{{ $student->asal_sekolah }}"
                            ...
                            placeholder="Asal Sekolah" disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="no_telp" value="{{ $student->no_telp }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nama_ortu" value="{{ $student->no_telp_ortu }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="pekerjaan_ortu" value="{{ $student->pekerjaan_ortu }}"
                            class="form-control @error('pekerjaan_ortu') is-invalid @enderror" id="inputPekerjaanOrtu"
                            placeholder="Pekerjaan Orang Tua" disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="no_telp_ortu" value="{{ $student->no_telp_ortu }}"
                            class="form-control @error('no_telp_ortu') is-invalid @enderror" id="inputNoTelpOrtu"
                            placeholder="No. Telepon Orang Tua" disabled>
